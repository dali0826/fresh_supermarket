...
class GoodsForm(forms.Form):
    ...
    category=forms.CharField(required=True,error_messages={'required':'商品类目必填'})
    ...
    shop_price=forms.CharField(required=True,error_messages={'required':'商品简短描述必填'})
    goods_brief=forms.CharField(required=True,error_messages={'required':'市场价格必填'})
    ...
    def clean_category(self):
        ...
        if category:
            ...
            raise forms.ValidationError({'category':'商品信息有误'})
